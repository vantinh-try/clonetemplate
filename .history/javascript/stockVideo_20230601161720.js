...
const hoverPlay1 = document.querySelector(".dowfile-video1");

hoverPlay1.addEventListener("mouseover", function () {
    hoverPlay1.play();
    hoverPlay1.setAttribute("controls", "hover");
    hoverPlay1.currentTime = 0;
});
hoverPlay1.addEventListener("mouseout", function () {
    hoverPlay1.pause();
    hoverPlay1.removeAttribute("controls", "hover");
    hoverPlay1.currentTime = 10.5;
});
