...
// const hoverPlay = document.getElementsByClassName(".dowfile-video");
const hoverPlay = document.querySelectorAll(".dowfile-video");
hoverPlay.addEventListener("mouseover", function (e) {
    e.play();
    e.setAttribute("controls", "hover");
    e.currentTime = 0;
    console.log("123");
});
hoverPlay.addEventListener("mouseout", function (e) {
    e.pause();
    e.removeAttribute("controls", "hover");
    e.currentTime = 10.5;
});
