...
function playVideo(video) {
    if (video.paused) {
        video.play();
        video.setAttribute("controls", "hover");
        imagePoster.style.display = "none";
        video.sytle.display = "block";
    }
}
function pauseVideo(video) {
    if (video.play) {
        ...
        imagePoster.style.position = "absolute";
        imagePoster.style.objectFit = "cover";
        // imagePoster.style.zIndex = "2";
    }
}
// function isShowPoster(image) {
