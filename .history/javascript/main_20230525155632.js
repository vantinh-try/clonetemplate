...
let dropMenuContent = document.createTextNode
dropMenu.addEventListener("click", isShowDropMenu);
function isShowDropMenu() {
        dropMenu.i
}
const navSearch = document.createElement("div");
navSearch.classList.add("nav_search-dropcontent")
navSearch.innerHTML(`
<p>search items</p>
<ul class="menu_list">
